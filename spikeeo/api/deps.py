...
from spikeeo.api.auth import _api_key_header, get_current_api_key
from spikeeo.db.crud import get_user_by_id
from spikeeo.db.models import APIKey, User
from spikeeo.db.session import AsyncSessionLocal
...
async def get_current_user(api_key: ApiKeyDep, db: DbDep) -> User:
    ...
    Raises:
        HTTPException 401: If user is inactive or deleted.
    """
